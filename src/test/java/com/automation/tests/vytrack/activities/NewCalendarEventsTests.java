...
import com.automation.utilities.DateTimesUtilities;
...
public class NewCalendarEventsTests extends AbstractTestBase {
    ...
    public void defaultOptionsTest() {
        ...
        String expectedStartDate = DateTimesUtilities.getCurrentDate("MMM d, yyyy").replace(".", "");
    ...
    public void timeDifferenceTest() {
        ...
        String replace = format.replace(".", "").toUpperCase();


        long actual = DateTimesUtilities.getTimeDifference(startTime, endTime, format);
